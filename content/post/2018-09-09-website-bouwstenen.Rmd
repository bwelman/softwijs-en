...
10. [WinSCP](https://winscp.net/), an open source Windows SFTP/FTP client for synchronizing the local website to the production server
...
2.  Creating a new RStudio project for this website, based on theme *hugo-theme-docdock*.
3.  Changed the project folder in a Git repository.
4.  Made various adjustments for structure and layout.
5.  New content created.
6.  After testing, copied the website to the server.
